...
import { Bot, LayoutTemplate, Menu, Mic2, Rocket, Wand2 } from "lucide-react";
      ...
      <main className="flex-1 overflow-x-hidden">
        <div className="sticky top-0 z-20 flex items-center justify-between border-b border-slate-200 bg-white/90 px-4 py-3 backdrop-blur dark:border-white/10 dark:bg-slate-950/90 lg:hidden">
          ...
          <div className="flex items-center gap-1">
            ...
            <Link href="/dashboard/voice" className="grid h-10 w-10 place-items-center rounded-lg text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10"><Mic2 className="h-5 w-5" /></Link>
            <Link href="/dashboard/landing-studio" className="grid h-10 w-10 place-items-center rounded-lg text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10"><LayoutTemplate className="h-5 w-5" /></Link>
